        ...
        <div className="flex flex-row justify-center items-end gap-3 sm:gap-6 mt-[-15vw] md:mt-[-22vw] lg:mt-[-14vw] relative z-20">
           ...
           {deals.map((deal, idx) => (
             <motion.div 
               ...
               className="flex flex-col bg-transparent w-[30%] max-w-[280px] deep-card rounded-xl overflow-hidden group cursor-pointer"
             ...
             >
               ...
               <div className="w-full aspect-[3/4] bg-[#050a07] relative overflow-hidden">
                  <img 
                    src={deal.image} 
                    className="w-full h-full object-cover filter grayscale opacity-70 group-hover:grayscale-0 group-hover:scale-110 group-hover:opacity-100 transition-all duration-[800ms]" 
                    alt={deal.title} 
                  />
               ...
               {/* Card Bottom Box */}
               <div className="bg-[#f3f7f3] border-t border-[#e2e8f0] px-4 sm:px-6 py-4 sm:py-6 w-full flex flex-col text-left group-hover:bg-white transition-colors duration-500">
                  <span 
                    className="font-bold text-[#001a00] text-sm sm:text-lg mb-1 tracking-wide"
                    style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                  >
                    {deal.title}
                  </span>
                  <span className="text-[#2e7d32] text-[10px] sm:text-xs font-black tracking-widest uppercase">
                    {deal.price}
                  </span>
               </div>
             </motion.div>
